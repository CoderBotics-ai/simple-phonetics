...
public class Helper {
	...
	// The enum declaration is already compatible with Java 21
	// Java 21 features like enhanced pattern matching in switch and record patterns
	// are not needed for this simple utility class
